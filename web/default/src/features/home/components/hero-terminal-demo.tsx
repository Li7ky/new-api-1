    ...
    <div className={cn('mx-auto w-full max-w-2xl', props.className)}>
      <div
        className={cn(
          ...
          'border-border/60 bg-background/95 organic-shadow',
          'dark:border-white/[0.06] dark:bg-background/95'
        )}
      >
        {/* Tab strip */}
        <div
        ...
        >
          ...
          <div className='ml-auto flex items-center gap-2 pr-2 sm:pr-3'>
            <span className='inline-block size-1.5 rounded-full bg-success shadow-[0_0_8px_oklch(from_var(--success)_l_c_h_/_0.4)]' />
