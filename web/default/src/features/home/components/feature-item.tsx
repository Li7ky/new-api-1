  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/15 to-secondary/10 ring-1 ring-primary/15 transition-all duration-300 group-hover/feature:scale-110 group-hover/feature:ring-primary/30'>
          {icon}
        </div>
      </div>
      {/* Title */}
